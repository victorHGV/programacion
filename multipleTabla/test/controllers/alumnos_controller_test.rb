...
class AlumnosControllerTest < ActionController::TestCase
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post :create, alumno: { apellido: @alumno.apellido, nac: @alumno.nac, nombre: @alumno.nombre, strinf: @alumno.strinf }
    end
  ...
  test "should update alumno" do
    patch :update, id: @alumno, alumno: { apellido: @alumno.apellido, nac: @alumno.nac, nombre: @alumno.nombre, strinf: @alumno.strinf }
    assert_redirected_to alumno_path(assigns(:alumno))
  end
